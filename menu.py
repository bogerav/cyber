...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text2("Options", 55, self.optionsx, self.optionsy)
            self.game.draw_text3("Options", 50, self.optionsx, self.optionsy)
...
class OptionsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.check_input()
            self.game.display.blit(self.game.sprite_image, (0, 0))
            self.game.draw_text2('Options', 105, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 100)
            self.game.draw_text('Options', 100, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 100)
